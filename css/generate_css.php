...
.selected-slot{background:<?php echo $time_selected_color;?>;}
.notavailable { background:lightgray;display:none;}
...
div.error p{margin-bottom:0px !important;} 
