...
class BkxSeat {
	...
	public function get_title() {
        ...
        public function get_seat_personal_info()
        {
            ...
            $get_seat_personal_info['seat_street']      = $meta_data['seat_street'][0];
            $get_seat_personal_info['seat_city']        = $meta_data['seat_city'][0];
            $get_seat_personal_info['seat_state']       = $meta_data['seat_state'][0];
            $get_seat_personal_info['seat_zip']         = $meta_data['seat_zip'][0];
            $get_seat_personal_info['seat_country']     = $meta_data['seat_country'][0];
        ...
        public function get_seat_available_months()
        {
            ...
            $seat_is_certain_month = $meta_data['seat_is_certain_month'][0]; // Check is enable or not
        ...
        {
            $meta_data = $this->meta_data;
            $seat_is_certain_day = $meta_data['seat_is_certain_day'][0]; // Check is enable or not
