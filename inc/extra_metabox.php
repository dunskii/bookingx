...
function bkx_extra_boxes_metabox_callback()
{
	...
	<div class="active" id="base_name">		
            ...
            <div class="plugin-description">
                    <input name="addition_price" type="text"  id="id_addition_price" value="<?php echo isset($addition_price) ? $addition_price : ''; ?>">
            </div>	
	</div>
	...
	<div class="active" id="overlap">
            ...
            <div class="plugin-description">
                    ...
                    <input name="addition_overlap" type="radio" value="Own Time Bracket" id="choice_14_0" tabindex="5" <?php if($addition_overlap == "N") echo "checked='true'"; ?> >
                    <label for="choice_14_0">Own Time Bracket</label>
                    </li>
                    <li class="gchoice_14_1">
                    <input name="addition_overlap" type="radio" value="Overlap" id="choice_14_1" tabindex="6" <?php if($addition_overlap == "Y") echo "checked='true'"; ?> >
	...
	<div class="active" id="base_name">
            ...
            <li class="gchoice_9_1">
                    <input name="addition_base_all" type="checkbox" value="All" id="id_addition_base_all" tabindex="12" <?php /*if($addition_bases=="All"){ echo "checked='checked'"; }*/ ?> >
            ...
            <input name="addition_base[]" type="checkbox" value="<?php echo $value->ID; ?>" tabindex="13" class="myCheckbox" <?php if($selected==true){ echo "checked='checked'";  } ?>>
...
<p><input type="text" name="extra_colour" id="id_extra_colour" value="<?php if(isset($extra_colour) && ($extra_colour!='')){ echo $extra_colour; } ?>" /></p>
	...
	<div class="active" id="is_unavailable" >		
            ...
            <div class="plugin-description">
                    <input type="checkbox" name="addition_is_unavailable" id="id_addition_is_unavailable" value="Yes" <?php if($addition_is_unavailable=="Y"){ echo "checked='checked'"; } ?>>
                    <label>Yes</label>
            </div>
	</div>	
	<div class="active" id="unavailable_from">		
            ...
            <div class="plugin-description">
                    <input type="text" name="addition_unavailable_from" id="id_addition_unavailable_from"  value="<?php if(isset($addition_available_from)){ echo $addition_available_from; } ?>"> From 				
            </div>
            <div class="plugin-description">
                    <input type="text" name="addition_unavailable_to" id="id_addition_unavailable_to"  value="<?php if(isset($addition_available_to)){ echo $addition_available_to; } ?>"> To				
            </div>		
	</div>       
<?php
}
