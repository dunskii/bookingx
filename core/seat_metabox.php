...
function bkx_seat_boxes_metabox_callback($post)
{
    ...
    bkx_custom_load_scripts(array('timepicker_implementation_1.js'));
    ...
    <div id="certain_month">
        ...
        <ul class="gfield_checkbox" id="input_1_16">
            ...
            <li class="gchoice_16_13">
                <input name="seat_certain_month[]" class="months_checkbox" type="checkbox" value="December"
                       id="choice_16_13"
...
function save_bkx_seat_metaboxes($post_id, $post, $update)
{
    ...
    $remove_biz_days = sanitize_text_field($_POST['remove_biz_days']);
