...
/**
* bookingx Meta Box Functions
*
* @author      WooThemes
* @category    Core
* @package     bookingx/Admin/Functions
* @version     2.3.0
*/
if ( ! defined( 'ABSPATH' ) ) {
 ...
 * @param array $field
 */
function bookingx_wp_text_input( $field ) {
 ...
 * @param array $field
 */
function bookingx_wp_hidden_input( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function bookingx_wp_textarea_input( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function bookingx_wp_checkbox( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function bookingx_wp_select( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function bookingx_wp_radio( $field ) {
	global $thepostid, $post;
