...
class Bookingx_Admin
{
    ...
    public function bkx_create_seat_post_type()
    {
        ...
        $labels = array(
            ...
            'add_new_item' => __("Add New {$alias_seat}", 'bookingx'),
            'add_new' => __("Add New {$alias_seat}", 'bookingx'),
            'edit_item' => __("Edit {$alias_seat}", 'bookingx'),
    ...
    public function bkx_create_addition_post_type()
    {
        ...
        $labels = array(
            ...
            'add_new_item' => __("Add New {$bkx_alias_addition}", 'bookingx'),
            'add_new' => __("Add New {$bkx_alias_addition}", 'bookingx'),
            'edit_item' => __("Edit {$bkx_alias_addition}", 'bookingx'),
            'update_item' => __("Update {$bkx_alias_addition}", 'bookingx'),
