...
if (!empty($current_submenu_active) && $current_submenu_active == 'alias') :?>
    ...
    <form name="form_alias" id="id_form_alias" method="post">
        <table cellspacing="0" class="widefat " style="margin-top:20px;">
            ...
            <tr class="active">
                <th scope="row"><label
                            for="Resource"><?php printf(esc_html__('%1$s', 'bookingx'), 'Resource'); ?></label></th>
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="text" name="seat_alias" id="id_seat_alias"
                               value="<?php echo bkx_crud_option_multisite('bkx_alias_seat'); ?>">
                    </div>
                </td>
            </tr>
            <tr class="active">
                <th scope="row"><label for="Service"><?php printf(esc_html__('%1$s', 'bookingx'), 'Service'); ?></label>
                </th>
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="text" name="base_alias" id="id_base_alias"
                               value="<?php echo bkx_crud_option_multisite('bkx_alias_base'); ?>">
                    </div>
                </td>
            </tr>
            <tr class="active">
                <th scope="row"><label for='Extras'><?php printf(esc_html__('%1$s', 'bookingx'), 'Extras'); ?></label>
                </th>

                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="text" name="addition_alias" id="id_addition_alias"
                               value="<?php echo bkx_crud_option_multisite('bkx_alias_addition'); ?>">
                    </div>
                </td>
            </tr>
   <!--         <tr class="active">
            ...
            <tr class="active">
                <th scope="row"><label
                            for="bkx_label_of_step1 Text"><?php printf(esc_html__('%1$s', 'bookingx'), 'Label for booking form Step 1 '); ?></label>
                </th>
                <td class="plugin-description">
                    <div class="plugin-description">
                        <textarea name="bkx_label_of_step1"
                                  cols="50"><?php echo bkx_crud_option_multisite('bkx_label_of_step1'); ?></textarea>
                    </div>
                </td>
            </tr>

            <tr class="active">
                <th scope="row"><label for="extended Text">Label
                        for <?php echo bkx_crud_option_multisite('bkx_alias_base'); ?> time be extended text</label>
                </th>
                <td class="plugin-description">
                    <div class="plugin-description">
                        <textarea name="bkx_notice_time_extended_text_alias"
                                  cols="50"><?php echo bkx_crud_option_multisite('bkx_notice_time_extended_text_alias'); ?></textarea>
                    </div>
                </td>
            </tr>
        ...
        <p class="submit"><input type="submit" onclick="" class='button-primary' name="save_alias" id="id_save_alias"
    ...
    <form name="form_template" id="id_form_template" method="post">
        <table cellspacing="0" class="widefat bkx-content-settings" style="margin-top:20px;">
            ...
            <tr class="active header">
                <th scope="row"><label
                            for="<?php echo esc_html__('Taxonomy Settings', 'bookingx'); ?>"><?php echo esc_html__('Taxonomy Settings', 'bookingx'); ?></label>
                </th>
            </tr>
            ...
            <tr class="active">
                <th scope="row"><label
                            for="Enable <?php printf(esc_html__('%1$s', 'bookingx'), $seat_alias); ?> Taxonomy"><?php printf(esc_html__('%1$s', 'bookingx'), "Enable $seat_alias Taxonomy"); ?></label>
                </th>
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="radio" name="bkx_seat_taxonomy_status" id="id_enable_seat_taxonomy_yes"
                               value="1" <?php if (bkx_crud_option_multisite('bkx_seat_taxonomy_status') == 1) echo "checked"; ?>><?php printf(esc_html__('%1$s', 'bookingx'), 'Yes'); ?>
                        <input type="radio" name="bkx_seat_taxonomy_status" id="id_enable_seat_taxonomy_no"
                               value="0" <?php if (bkx_crud_option_multisite('bkx_seat_taxonomy_status') == 0) echo "checked"; ?>>
            ...
            <tr class="active">
                <th scope="row"><label
                            for="Enable <?php printf(esc_html__('%1$s', 'bookingx'), $base_alias); ?> Taxonomy"><?php printf(esc_html__('%1$s', 'bookingx'), "Enable $base_alias Taxonomy"); ?></label>
                </th>

                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="radio" name="bkx_base_taxonomy_status" id="id_enable_base_taxonomy_yes"
                               value="1" <?php if (bkx_crud_option_multisite('bkx_base_taxonomy_status') == 1) echo "checked"; ?>><?php printf(esc_html__('%1$s', 'bookingx'), 'Yes'); ?>
                        <input type="radio" name="bkx_base_taxonomy_status" id="id_enable_base_taxonomy_no"
                               value="0" <?php if (bkx_crud_option_multisite('bkx_base_taxonomy_status') == 0) echo "checked"; ?>>
                        <?php printf(esc_html__('%1$s', 'bookingx'), 'No'); ?>
                    </div>
                </td>
            </tr>
            ...
            <tr class="active">
                <th scope="row"><label
                            for="Enable <?php printf(esc_html__('%1$s', 'bookingx'), $addition_alias); ?> Taxonomy"><?php printf(esc_html__('%1$s', 'bookingx'), "Enable $addition_alias Taxonomy"); ?></label>
                </th>

                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="radio" name="bkx_addition_taxonomy_status" id="id_bkx_addition_taxonomy_status_yes"
                               value="1" <?php if (bkx_crud_option_multisite('bkx_addition_taxonomy_status') == 1) echo "checked"; ?>><?php printf(esc_html__('%1$s', 'bookingx'), 'Yes'); ?>
                        <input type="radio" name="bkx_addition_taxonomy_status" id="id_bkx_addition_taxonomy_status_no"
                               value="0" <?php if (bkx_crud_option_multisite('bkx_addition_taxonomy_status') == 0) echo "checked"; ?>>
                        <?php printf(esc_html__('%1$s', 'bookingx'), 'No'); ?>
                    </div>
                </td>
            </tr>
            <tr class="active header">
                <th scope="row"><label
                            for="<?php echo esc_html__('Other Settings', 'bookingx'); ?>"><?php echo esc_html__('Other Settings', 'bookingx'); ?></label>
                </th>
            </tr>
            <tr class="active">
                <th scope="row"><label
                            for="Set Booking Page"><?php printf(esc_html__('%1$s', 'bookingx'), 'Set Booking Page'); ?></label>
                </th>
            ...
            <tr class="active">
                ...
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="radio" name="bkx_legal_options" id="id_bkx_legal_options_yes"
                               value="1" <?php if (bkx_crud_option_multisite('bkx_legal_options') == 1) echo "checked"; ?>><?php printf(esc_html__('%1$s', 'bookingx'), 'Yes'); ?>
                        <input type="radio" name="bkx_legal_options" id="id_bkx_legal_options_no"
                               value="0" <?php if (bkx_crud_option_multisite('bkx_legal_options') == 0) echo "checked"; ?>> <?php printf(esc_html__('%1$s', 'bookingx'), 'No'); ?>
                    </div>
                </td>
            </tr>
            ...
            <tr class="active">
                ...
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="radio" name="enable_editor" id="id_enable_editor_yes"
                               value="1" <?php if (bkx_crud_option_multisite('enable_editor') == 1) echo "checked"; ?>><?php printf(esc_html__('%1$s', 'bookingx'), 'Yes'); ?>
                        <input type="radio" name="enable_editor" id="id_enable_editor_no"
                               value="0" <?php if (bkx_crud_option_multisite('enable_editor') == 0) echo "checked"; ?>>
                        <?php printf(esc_html__('%1$s', 'bookingx'), 'No'); ?>
                    </div>
                </td>
            </tr>
        ...
        <p class="submit"><input type="submit" onclick="" class='button-primary' name="save_template"
                                 id="id_save_template" value="Save Changes"/></p>
    </form>
<?php endif; ?>
...
<?php if (!empty($current_submenu_active) && $current_submenu_active == 'emails') : ?>
    ...
    if ($current_main_tab == 'bkx_general' && $section == 'emails' && isset($sub_tab) && $sub_tab != '') {
        ...
        if ($sub_tab) {
            foreach ($email_templates as $email_key => $email) {
                if (strtolower($email_key) === $sub_tab) {
                    ...
                    <h3> <?php printf(esc_html__('%1$s', 'bookingx'), $email->title); ?> <a
                                href="<?php echo $generate_tab_url; ?>"> Back </a></h3>
        ...
        <input type="hidden" name="bkx_setting_form_init" value="1">
        <p class="submit"><input type="submit" onclick="" class='button-primary' name="bkx_save_<?php echo $sub_tab; ?>"
                                 id="bkx_save_<?php echo $sub_tab; ?>" value="Save Changes"/></p>
        </form>
        <?php
    } else { ?>
        <h3> <?php printf(esc_html__('%1$s', 'bookingx'), $bkx_general_submenu_label); ?> </h3>
...
<?php if (!empty($current_submenu_active) && $current_submenu_active == 'css') : ?>
    ...
    <form name="form_siteuser" id="id_form_sitecss" method="post">
        <table cellspacing="0" class="widefat" style="margin-top:20px;">
            ...
            <tr class="active">
                <th scope="row"><label
                            for="Set Booking Style"><?php printf(esc_html__('%1$s', 'bookingx'), 'Calendar Layout'); ?></label>
                </th>
                <td class="plugin-description">
                    ...
                    <?php if ($bkx_booking_style == "" || $bkx_booking_style == 'default') { ?>
                        <a href="<?php echo BKX_PLUGIN_PUBLIC_URL; ?>/images/preview/2.jpg"
                           class="bkx-preview-<?php echo $bkx_booking_style; ?> thickbox">Preview</a>
                    <?php } ?>
                    <?php if ($bkx_booking_style == 'day_style') { ?>
                        <a href="<?php echo BKX_PLUGIN_PUBLIC_URL; ?>/images/preview/2b.jpg"
                           class="bkx-preview-<?php echo $bkx_booking_style; ?> thickbox">Preview</a>
                    <?php } ?>
                </td>
            </tr>
            ...
            <tr class="active">
                ...
                <td class="plugin-description">
                    <input type="text" name="bkx_cal_day_selected_color" id="id_bkx_cal_day_selected_color"
                           value="<?php echo bkx_crud_option_multisite('bkx_cal_day_selected_color'); ?>">
                </td>
            </tr>
            ...
            <tr class="active">
                ...
                <td class="plugin-description">
                    <input type="text" name="bkx_time_selected_color" id="id_bkx_time_selected_color"
            ...
            <tr class="active">
                ...
                <td class="plugin-description">
                    <input type="text" name="bkx_time_unavailable_color" id="id_bkx_time_unavailable_color"
                           value="<?php echo bkx_crud_option_multisite('bkx_time_unavailable_color'); ?>">
                </td>
            </tr>
        ...
        <p class="submit"><input type="submit" onclick="" class='button-primary' name="save_sitecss"
                                 id="id_save_sitecss" value="Save Changes"/></p>
    </form>
<?php endif; ?>
...
<?php if (!empty($current_submenu_active) && $current_submenu_active == 'other_settings') : ?>
    ...
    <form name="form_other_setting" id="id_other_setting" method="post">
        <table cellspacing="0" class="widefat" style="margin-top:20px;">
            ...
            <tr class="active">
                <th scope="row"><label
                            for="Cancel Booking"><?php printf(esc_html__('%1$s', 'bookingx'), 'Enable Cancel Booking'); ?></label>
                </th>

                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="radio" name="enable_cancel_booking" id="id_enable_cancel_booking_yes"
                               value="1" <?php if (bkx_crud_option_multisite('enable_cancel_booking') == 1) echo "checked"; ?>><?php printf(esc_html__('%1$s', 'bookingx'), 'Yes'); ?>
                        <input type="radio" name="enable_cancel_booking" id="id_enable_cancel_booking_no"
                               value="0" <?php if (bkx_crud_option_multisite('enable_cancel_booking') == 0) echo "checked"; ?>><?php printf(esc_html__('%1$s', 'bookingx'), 'No'); ?>
                    </div>
                </td>
            </tr>
            <tr class="active" style="display:none;" id="page_drop_down_cancel_booking">
                <th scope="row"><label
                            for="Cancellation"><?php printf(esc_html__('%1$s', 'bookingx'), 'Select Page for Cancellation Policy '); ?></label>
                </th>

                <td class="plugin-description">
                    <div class="plugin-description">
                        <?php $args = array('selected' => bkx_crud_option_multisite('cancellation_policy_page_id'));
                        wp_dropdown_pages($args); ?>
                    </div>
                </td>
            </tr>
            <tr class="active">
                <th scope="row"><label
                            for="ANY"> <?php printf(esc_html__('Allow "Any" for %1$s option', 'bookingx'), bkx_crud_option_multisite('bkx_alias_seat')); ?></label>
                </th>

                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="radio" name="enable_any_seat" id="id_enable_any_seat_yes"
                               value="1" <?php if (bkx_crud_option_multisite('enable_any_seat') == 1) echo "checked"; ?>><?php printf(esc_html__('%1$s', 'bookingx'), 'Yes'); ?>
                        <input type="radio" name="enable_any_seat" id="id_enable_any_seat_no"
                               value="0" <?php if (bkx_crud_option_multisite('enable_any_seat') == 0) echo "checked"; ?>> <?php printf(esc_html__('%1$s', 'bookingx'), 'No'); ?>
                    </div>
                </td>
            </tr>
            ...
            <tr class="active">
                <th scope="row"><label
                            for="dashboard column's bookings"><?php printf(esc_html__('%1$s', 'bookingx'), 'Dashboard Column\'s'); ?></label>
                </th>
                <td class="plugin-description">
                    <div class="plugin-description">
                        <?php
                        ...
                        ?>
                        <input type="checkbox" class="bkx-dashboard-column-all" <?php echo $column_checked; ?>> Select
                        All <br/>
        ...
        <p class="submit"><input type="submit" onclick="" class='button-primary' name="save_other_setting"
                                 id="id_save_other_setting" value="Save Changes"/></p>
    </form>
    <!---End Other settings-->
<?php endif; ?>
...
<?php if (!empty($current_submenu_active) && $current_submenu_active == 'exim') : ?>
    ...
    <div>
        ...
        if (!is_writable($bkx_export_file_name)) {
            echo "<strong> Please allow file permission to generate file on " . BKX_PLUGIN_DIR_PATH . "uploads Directory.</strong>";
        }
        ?>
        <form name="xml_export" method="post" action="">
            ...
            <p class="submit"><input type="submit" value="Export xml" <?php echo $bkx_export_enable; ?>
                                     class='button-primary' name="export_xml"></p>
        </form>
    </div>
                ...
                <tr class="active">
                    <td>
                        <div><input type="checkbox"
                                    name="truncate_records"><small><?php printf(esc_html__('( %1$s %2$s\'s , %3$s\'s , %4$s\'s , Booking data and All Setting\'s  )', 'bookingx'), 'Check to delete all existing', $seat_alias, $base_alias, $addition_alias); ?></small>
                        </div>
