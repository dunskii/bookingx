    ...
    <form name="form_api" id="id_form_api" method="post">
        <table cellspacing="0" class="widefat bkx-admin-paypal-settings" style="margin-top:20px;">
            ...
            <tr class="active">
                ...
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="radio" name="paypal_status" id="id_paypal_status_on"
                               value="1" <?php if (bkx_crud_option_multisite('bkx_gateway_paypal_express_status') == 1) echo "checked"; ?>>Enable
                        <input type="radio" name="paypal_status" id="id_paypal_status_off"
                               value="0" <?php if (bkx_crud_option_multisite('bkx_gateway_paypal_express_status') == 0) echo "checked"; ?>>
                        Disable
                    </div>
                </td>
            </tr>
            <tr class="active">
                ...
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="radio" name="paypalmode" id="id_modesandbox"
                               value="sandbox" <?php if (bkx_crud_option_multisite('bkx_api_paypal_paypalmode') == "sandbox") echo "checked"; ?>>Sandbox
                        <input type="radio" name="paypalmode" id="id_modelive"
                               value="live" <?php if (bkx_crud_option_multisite('bkx_api_paypal_paypalmode') == "live") echo "checked"; ?>>
                        Live
                    </div>
                </td>
            </tr>
                ...
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="text" name="username" id="id_username"
                               value="<?php echo bkx_crud_option_multisite('bkx_api_paypal_username'); ?>">
                    </div>
                </td>
            </tr>
            <tr class="active">
                ...
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="text" name="password" id="id_password"
                               value="<?php echo bkx_crud_option_multisite('bkx_api_paypal_password'); ?>">
                    </div>
                </td>
            </tr>
            <tr class="active">
                ...
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="text" name="signature" id="id_signature"
                               value="<?php echo bkx_crud_option_multisite('bkx_api_paypal_signature'); ?>">
                    </div>
                </td>
            </tr>
        ...
        <p class="submit"><input type="submit" onclick="" class='button-primary' name="save_api" id="id_save_api"
    ...
    <form name="form_tax_option" id="id_form_tax_option" method="post">
        <table cellspacing="0" class="widefat " style="margin-top:20px;">
            ...
            <tr class="active">
                ...
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="number" min="0" name="bkx_tax_rate" id="id_bkx_tax_rate"
                               value="<?php echo bkx_crud_option_multisite('bkx_tax_rate'); ?>">
                    </div>
                </td>
            </tr>
            ...
            <tr class="active">
                ...
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="text" name="bkx_tax_name" id="id_bkx_tax_name"
                               value="<?php echo bkx_crud_option_multisite('bkx_tax_name'); ?>">
                    </div>
                </td>
            </tr>
            ...
            <tr class="active">
                ...
                <td class="plugin-description">
                    <div class="plugin-description">
                        <input type="radio" name="bkx_prices_include_tax" id="id_bkx_prices_include_tax_yes"
                               value="1" <?php if ($bkx_prices_include_tax == 1) echo "checked"; ?>> Yes, I will enter
                        prices inclusive of tax  </br>
                        <input type="radio" name="bkx_prices_include_tax" id="id_bkx_prices_include_tax_no"
                               value="0" <?php if ($bkx_prices_include_tax == 0) echo "checked"; ?>> No, I will enter
        ...
        <p class="submit"><input type="submit" onclick="" class='button-primary' name="save_tax" id="id_save_tax"
                                 value="Save Changes"/></p>
    </form>
    <!-- End Tax Setting -->
<?php endif; ?>
<?php if (!empty($current_submenu_active) && $current_submenu_active == 'currency') : ?>
    ...
    <form name="form_payment_option" id="id_form_payment_option" method="post">
        ...
        <p class="submit"><input type="submit" onclick="" class='button-primary' name="save_currency_option"
                                 id="id_save_currency_option" value="Save Changes"/></p>
    </form>
<?php endif; ?>