...
if (!empty($current_submenu_active) && $current_submenu_active == 'biz_info') :?>
    ...
    <form name="form_alias" id="id_form_alias" method="post">
        ...
        <p class="submit"><input type="submit" onclick="" class='button-primary' name="bkx_save_business"
                                 id="id_save_business" value="Save Changes"/></p>
    </form>
<?php endif; ?>
...
<?php if (!empty($current_submenu_active) && $current_submenu_active == 'days_ope') : ?>
    ...
    <form name="bkx_form_alias" id="id_form_alias" method="post">
        ...
        <div class="clear"></div>
        <p class="submit"><input type="submit" onclick="" class='button-primary' name="save_days_ope"
                                 id="id_save_days_ope" value="Save Changes"/></p>
    </form>
<?php endif; ?>
    <div class="clear"></div>
<?php
if (!empty($current_submenu_active) && $current_submenu_active == 'user_opt') :?>
    <!--<h3> <?php /*printf( esc_html__( '%1$s', 'bookingx' ),  'Site User Option' ); */
    ?> </h3>
		...
		<tr class="active">
			...
			<td class="plugin-description">
					<select name="can_edit_seat" id="id_can_edit_seat">
						<option value="Y" <?php /*if($temp_option=="Y"){echo "selected";} */
    ?> >Yes</option>
						<option value="N" <?php /*if($temp_option=="N" || $temp_option == "default"){echo "selected";} */
    ?> >No</option>
					</select>				
			</td>
		</tr>
...
<p class="submit"><input type="submit" onclick="" class='button-primary' name="save_siteuser" id="id_save_siteuser" value="Save Changes" /></p>
    ...
    <form name="form_role_setting" id="id_role_setting" method="post">
        ...
        <p class="submit"><input type="submit" onclick="" class='button-primary' name="save_role_setting"
                                 id="id_save_role_setting" value="Save Changes"/></p>
    </form>
<?php endif; ?>