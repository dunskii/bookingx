...
?>
    ...
    <div class="col-md-12 bkx-change-password-main">
        ...
        <div class="card card-outline-secondary">
            ...
            <div class="card-body">
                <div class="alert alert-success bkx-change-password-success-message" style="display: none;"
                     role="alert"></div>
                <form class="form bkx-change-password-form" method="post" id="bkx-change-password" role="form"
                      autocomplete="off">
                    <div class="form-group">
                        <label for="inputPasswordOld"><?php esc_html_e('Current Password', 'bookingx'); ?></label>
                        <input type="password" name="current_password" class="form-control bkx-current_password"
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="new_password" class="form-control bkx-new_password"
                               id="inputPasswordNew" required="">
                        <span class="form-text small text-muted"><?php echo __('Recommended : The password must be 8-20 characters, and must <em>not</em> contain spaces.', 'bookingx'); ?></span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="confirm_password" class="form-control bkx-confirm_password"
