                    ...
                    <div class="white-block">
                        <div class="row">
                            <?php if ($is_mobile == 0): ?>
                                ...
                                <div class="col-4">
                                    <h2 class="title-block"><a href="<?php echo get_permalink() ?>">Back to Bookings</a>
                                    </h2>
                                </div>
                            <?php else: ?>
                                <div class="col-12">
                        ...
                        <div class="content-block booking-info" style="margin: 0;">
                            ...
                            <p><label>Booking Total
                                    : </label> <?php echo esc_html("{$current_currency}{$order_meta['total_price']}"); ?>
                            </p>
                        ...
                        <?php if (!empty($payment_meta) && is_array($payment_meta)) { ?>
                            ...
                            <div class="content-block booking-info" style="margin: 0;">
                                <p><label>Payment Gateway
                                        : </label> <?php echo esc_html($payment_source, 'bookingx'); ?>   </p>
                                <?php if (isset($payment_source) && $payment_source != "Offline Payment") : ?>
                                    <p><label>Transaction ID
                                            : </label> <?php echo esc_html($transaction_id, 'bookingx'); ?>  </p>
                                <?php endif; ?>
                                <p><label>Payment Status
                                        : </label> <?php echo esc_html(ucwords($payment_status), 'bookingx'); ?>  </p>
                        ...
                        <div class="content-block booking-info" style="margin: 0;">
                            <p>
                                <label> <?php echo esc_html('Business Name :'); ?> </label> <?php echo esc_html($bkx_business_name); ?>
                            </p>
                            <p>
                                <label> <?php echo esc_html('Phone :'); ?></label> <?php echo esc_html($bkx_business_phone); ?>
                            </p>
                            <p>
                                <label> <?php echo esc_html('Email :'); ?> </label> <?php echo esc_html($bkx_business_email); ?>
                            </p>
                            <p>
                                <label> <?php echo esc_html('Address :'); ?></label> <?php echo esc_html($bkx_business_address); ?>
                            </p>
                        </div>
