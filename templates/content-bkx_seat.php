    ...
    <div class="card<?php echo $settings['block']; ?>" style="width: <?php echo $card_width; ?>">
        ...
        <div class="card-body">
            <h5 class="card-title m-0 text-center"><a
                        href="<?php echo get_permalink($seat_id); ?>"><?php echo get_the_title($seat_id); ?></a></h5>
            <p class="card-text"><?php echo wp_trim_words(get_the_content(), 15, '...'); ?></p>
            <div class="text-center"><a href="<?php echo $booking_url; ?>"
                                        class="btn btn-primary"><?php echo esc_html('Book now', 'bookingx'); ?></a>
            </div>
        </div>
    </div>
</div>