...
$base_id = $bkx_base->id;
$BaseObj = new BkxBase();
$price_duration = get_post_price_duration_plain( $bkx_base, $alias_base );
...
$available_seats = get_post_with_price_duration( $get_seat_by_base, $alias_seat );
$available_extras = get_post_with_price_duration( $get_extra_by_base, $alias_extra );
?>
