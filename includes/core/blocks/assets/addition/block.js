...
( function( blocks, element, serverSideRender, components, editor ) {
    ...
    const icon = el('svg', { className: 'bkx-svg', width : 24, height : 24, xmlns: 'http://www.w3.org/2000/svg', id : 'Layer_1', viewBox: '0 0 124 124'  },
        el('path', { class : 'bkx-svg',d: "M40.61,72.92a9.69,9.69,0,1,1,9.69-9.69A9.69,9.69,0,0,1,40.61,72.92Zm0-15.42a5.73,5.73,0,1,0,5.73,5.73A5.74,5.74,0,0,0,40.61,57.5Z" }),
        el('path', { class : 'bkx-svg',d: "M62.56,72.92a9.69,9.69,0,1,1,9.69-9.69A9.69,9.69,0,0,1,62.56,72.92Zm0-15.42a5.73,5.73,0,1,0,5.73,5.73A5.74,5.74,0,0,0,62.56,57.5Z" }),
        el('path', { class : 'bkx-svg',d: "M84.51,72.92a9.69,9.69,0,1,1,9.69-9.69A9.69,9.69,0,0,1,84.51,72.92Zm0-15.42a5.73,5.73,0,1,0,5.73,5.73A5.74,5.74,0,0,0,84.51,57.5Z" }),
     );
