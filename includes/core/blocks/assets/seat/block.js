...
( function( blocks, element, serverSideRender, components, editor ) {
    ...
    const main_icon = el('svg', { className: 'bkx-svg', width : 24, height : 24, xmlns: 'http://www.w3.org/2000/svg', id : 'Layer_1', viewBox: '0 0 124 124'  },
        ...
        el('path', { fill : '#333',d: "M42,61.2A18.6,18.6,0,1,1,60.62,42.6,18.62,18.62,0,0,1,42,61.2Zm0-33.32A14.73,14.73,0,1,0,56.75,42.6,14.74,14.74,0,0,0,42,27.88Z" }),
        el('path', { fill : '#333',d: "M42,101.26a18.6,18.6,0,1,1,18.59-18.6A18.62,18.62,0,0,1,42,101.26Zm0-33.33A14.73,14.73,0,1,0,56.75,82.66,14.75,14.75,0,0,0,42,67.93Z" }),
        el('path', { fill : '#333',d: "M42,93.48a1,1,0,0,1-.77-.38c-.74-1-7.24-9.49-7.24-13.47a8,8,0,0,1,16,0c0,4-6.5,12.51-7.24,13.47A1,1,0,0,1,42,93.48Zm0-19.71A6,6,0,0,0,36,79.63C36,82.12,39.82,87.9,42,90.9c2.2-3,6.07-8.78,6.07-11.27A6,6,0,0,0,42,73.77Z" }),
        el('path', { fill : '#333',d: "M42,82.92a3.08,3.08,0,1,1,3.07-3.08A3.08,3.08,0,0,1,42,82.92Zm0-4.22a1.15,1.15,0,1,0,1.14,1.14A1.14,1.14,0,0,0,42,78.7Z" }),
        el('path', { fill : '#333',d: "M92.25,43.47H71.83a1,1,0,0,1-1-1V37.79a1,1,0,0,1,1-1H92.25a1,1,0,0,1,1,1V42.5A1,1,0,0,1,92.25,43.47ZM72.8,41.54H91.28V38.76H72.8Z" }),
        ...
        el('path', { fill : '#333',d: "M82,60.38a18.57,18.57,0,1,1,18.57-18.57A18.59,18.59,0,0,1,82,60.38Zm0-33.27a14.7,14.7,0,1,0,14.7,14.7A14.71,14.71,0,0,0,82,27.11Z" }),
        el('path', { fill : '#333',d: "M78.87,89.89a1,1,0,0,1-.71-.32L73,83.92a1,1,0,1,1,1.42-1.31l4.48,4.88L89.6,75.79A1,1,0,1,1,91,77.1L79.58,89.57A1,1,0,0,1,78.87,89.89Z" }),
        el('path', { fill : '#333',d: "M82,100.53A18.58,18.58,0,1,1,100.57,82,18.59,18.59,0,0,1,82,100.53Zm0-33.28A14.71,14.71,0,1,0,96.7,82,14.72,14.72,0,0,0,82,67.25Z" }),
     );
