<?php
/**
 * BookingX Core All Block Loader Class
 *
...
require_once BKX_PLUGIN_DIR_PATH . '/includes/core/blocks/class-bkx-block.php';
...
class Bkx_Blocks {
	...
	/**
	 * bkx_block_categories
	 *
	 * @param  $categories
	 * @return array
	 */
	public function bkx_block_categories( $categories ) {
	...
	public static function register( $block ) {
		if ( ! is_subclass_of( $block, 'Bkx_Block' ) ) {
			return new WP_Error( 'block_not_subclass', 'Must be a subclass of Bkx_Block' );
		}
